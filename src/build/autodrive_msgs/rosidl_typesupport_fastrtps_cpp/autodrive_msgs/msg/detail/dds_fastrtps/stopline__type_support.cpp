...
#include "autodrive_msgs/msg/detail/stopline__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autodrive_msgs::msg::Stopline & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  autodrive_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ...
    cdr);
  // Member: stopline_confidence
  cdr << ros_message.stopline_confidence;
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autodrive_msgs::msg::Stopline & ros_message)
{
  // Member: detection
  ...
  size_t current_alignment)
{
  ...
  // Member: stopline_confidence
  {
    size_t item_size = sizeof(ros_message.stopline_confidence);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autodrive_msgs::msg::Stopline;
    is_plain =
      (
      offsetof(DataType, stopline_confidence) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const autodrive_msgs::msg::Stopline *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autodrive_msgs::msg::Stopline *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Stopline__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const autodrive_msgs::msg::Stopline *>(
...
static size_t _Stopline__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Stopline(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Stopline__callbacks = {
  "autodrive_msgs::msg",
  "Stopline",
...
static rosidl_message_type_support_t _Stopline__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Stopline__callbacks,
...
{
  return &autodrive_msgs::msg::typesupport_fastrtps_cpp::_Stopline__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autodrive_msgs, msg, Stopline)() {
  return &autodrive_msgs::msg::typesupport_fastrtps_cpp::_Stopline__handle;
}
