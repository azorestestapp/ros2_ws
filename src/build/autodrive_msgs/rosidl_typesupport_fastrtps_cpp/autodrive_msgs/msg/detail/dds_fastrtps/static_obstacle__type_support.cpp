...
#include "autodrive_msgs/msg/detail/static_obstacle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autodrive_msgs::msg::StaticObstacle & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.static_obstacle_confidence;
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autodrive_msgs::msg::StaticObstacle & ros_message)
{
  // Member: detection
  ...
  size_t current_alignment)
{
  ...
  // Member: static_obstacle_confidence
  {
    size_t item_size = sizeof(ros_message.static_obstacle_confidence);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autodrive_msgs::msg::StaticObstacle;
    is_plain =
      (
      offsetof(DataType, static_obstacle_confidence) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const autodrive_msgs::msg::StaticObstacle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autodrive_msgs::msg::StaticObstacle *>(
    untyped_ros_message);
...
{
  return &autodrive_msgs::msg::typesupport_fastrtps_cpp::_StaticObstacle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autodrive_msgs, msg, StaticObstacle)() {
  return &autodrive_msgs::msg::typesupport_fastrtps_cpp::_StaticObstacle__handle;
}
