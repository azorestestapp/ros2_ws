...
#include "autodrive_msgs/msg/detail/general_detection__rosidl_typesupport_fastrtps_c.h"
...
#include "vision_msgs/msg/detail/bounding_box3_d__functions.h"  // bounding_box
...
using _GeneralDetection__ros_msg_type = autodrive_msgs__msg__GeneralDetection;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _GeneralDetection__ros_msg_type * ros_message = static_cast<const _GeneralDetection__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _GeneralDetection__ros_msg_type * ros_message = static_cast<_GeneralDetection__ros_msg_type *>(untyped_ros_message);
  // Field name: bounding_box
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _GeneralDetection__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autodrive_msgs__msg__GeneralDetection(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autodrive_msgs__msg__GeneralDetection;
    is_plain =
      (
...
static size_t _GeneralDetection__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autodrive_msgs__msg__GeneralDetection(
...
static message_type_support_callbacks_t __callbacks_GeneralDetection = {
  "autodrive_msgs::msg",
  "GeneralDetection",
...
static rosidl_message_type_support_t _GeneralDetection__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_GeneralDetection,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autodrive_msgs, msg, GeneralDetection)() {
  return &_GeneralDetection__type_support;
}
