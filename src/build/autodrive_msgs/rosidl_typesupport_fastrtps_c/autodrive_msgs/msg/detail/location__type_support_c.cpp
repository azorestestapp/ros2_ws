...
#include "autodrive_msgs/msg/detail/location__rosidl_typesupport_fastrtps_c.h"
...
using _Location__ros_msg_type = autodrive_msgs__msg__Location;
...
static uint32_t _Location__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autodrive_msgs__msg__Location(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autodrive_msgs__msg__Location;
    is_plain =
      (
...
static size_t _Location__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autodrive_msgs__msg__Location(
