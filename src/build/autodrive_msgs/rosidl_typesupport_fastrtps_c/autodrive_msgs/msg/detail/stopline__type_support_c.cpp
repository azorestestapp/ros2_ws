...
#include "autodrive_msgs/msg/detail/stopline__rosidl_typesupport_fastrtps_c.h"
...
using _Stopline__ros_msg_type = autodrive_msgs__msg__Stopline;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: stopline_confidence
  {
...
static uint32_t _Stopline__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autodrive_msgs__msg__Stopline(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autodrive_msgs__msg__Stopline;
    is_plain =
      (
...
static size_t _Stopline__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autodrive_msgs__msg__Stopline(
