...
#include "autodrive_msgs/msg/detail/can_state__rosidl_typesupport_fastrtps_c.h"
...
using _CanState__ros_msg_type = autodrive_msgs__msg__CanState;
...
size_t get_serialized_size_autodrive_msgs__msg__CanState(
  const void * untyped_ros_message,
...
static uint32_t _CanState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autodrive_msgs__msg__CanState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autodrive_msgs
size_t max_serialized_size_autodrive_msgs__msg__CanState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autodrive_msgs__msg__CanState;
    is_plain =
      (
...
static size_t _CanState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autodrive_msgs__msg__CanState(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autodrive_msgs, msg, CanState)() {
