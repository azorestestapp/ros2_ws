...
#include "autodrive_msgs/msg/detail/static_obstacle__rosidl_typesupport_fastrtps_c.h"
...
using _StaticObstacle__ros_msg_type = autodrive_msgs__msg__StaticObstacle;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: static_obstacle_confidence
  {
...
static uint32_t _StaticObstacle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autodrive_msgs__msg__StaticObstacle(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autodrive_msgs__msg__StaticObstacle;
    is_plain =
      (
...
static size_t _StaticObstacle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autodrive_msgs__msg__StaticObstacle(
