...
#include "autodrive_msgs/msg/detail/direction__rosidl_typesupport_fastrtps_c.h"
...
using _Direction__ros_msg_type = autodrive_msgs__msg__Direction;
...
static uint32_t _Direction__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autodrive_msgs__msg__Direction(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autodrive_msgs__msg__Direction;
    is_plain =
      (
...
static size_t _Direction__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autodrive_msgs__msg__Direction(
