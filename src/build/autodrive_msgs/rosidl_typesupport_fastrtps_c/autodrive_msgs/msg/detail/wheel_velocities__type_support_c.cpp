...
#include "autodrive_msgs/msg/detail/wheel_velocities__rosidl_typesupport_fastrtps_c.h"
...
using _WheelVelocities__ros_msg_type = autodrive_msgs__msg__WheelVelocities;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: front_left_velocity
  {
    cdr << ros_message->front_left_velocity;
  }

  // Field name: front_right_velocity
  {
    cdr << ros_message->front_right_velocity;
  }

  // Field name: rear_left_velocity
  {
    cdr << ros_message->rear_left_velocity;
  }

  // Field name: rear_right_velocity
  {
...
size_t get_serialized_size_autodrive_msgs__msg__WheelVelocities(
  const void * untyped_ros_message,
...
static uint32_t _WheelVelocities__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autodrive_msgs__msg__WheelVelocities(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autodrive_msgs
size_t max_serialized_size_autodrive_msgs__msg__WheelVelocities(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autodrive_msgs__msg__WheelVelocities;
    is_plain =
      (
...
static size_t _WheelVelocities__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autodrive_msgs__msg__WheelVelocities(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autodrive_msgs, msg, WheelVelocities)() {
