...
autodrive_msgs__msg__VehicleState__create()
{
  ...
  autodrive_msgs__msg__VehicleState * msg = (autodrive_msgs__msg__VehicleState *)allocator.allocate(sizeof(autodrive_msgs__msg__VehicleState), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(autodrive_msgs__msg__VehicleState));
  bool success = autodrive_msgs__msg__VehicleState__init(msg);
  if (!success) {
...
autodrive_msgs__msg__VehicleState__destroy(autodrive_msgs__msg__VehicleState * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    autodrive_msgs__msg__VehicleState__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
autodrive_msgs__msg__VehicleState__Sequence__init(autodrive_msgs__msg__VehicleState__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autodrive_msgs__msg__VehicleState * data = NULL;

  if (size) {
    data = (autodrive_msgs__msg__VehicleState *)allocator.zero_allocate(size, sizeof(autodrive_msgs__msg__VehicleState), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = autodrive_msgs__msg__VehicleState__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        autodrive_msgs__msg__VehicleState__fini(&data[i - 1]);
      }
...
autodrive_msgs__msg__VehicleState__Sequence__fini(autodrive_msgs__msg__VehicleState__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      autodrive_msgs__msg__VehicleState__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autodrive_msgs__msg__VehicleState__Sequence * array = (autodrive_msgs__msg__VehicleState__Sequence *)allocator.allocate(sizeof(autodrive_msgs__msg__VehicleState__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = autodrive_msgs__msg__VehicleState__Sequence__init(array, size);
  if (!success) {
...
autodrive_msgs__msg__VehicleState__Sequence__destroy(autodrive_msgs__msg__VehicleState__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    autodrive_msgs__msg__VehicleState__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
autodrive_msgs__msg__VehicleState__Sequence__are_equal(const autodrive_msgs__msg__VehicleState__Sequence * lhs, const autodrive_msgs__msg__VehicleState__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autodrive_msgs__msg__VehicleState__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  autodrive_msgs__msg__VehicleState__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autodrive_msgs__msg__VehicleState);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    autodrive_msgs__msg__VehicleState * data =
      (autodrive_msgs__msg__VehicleState *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autodrive_msgs__msg__VehicleState__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autodrive_msgs__msg__VehicleState__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!autodrive_msgs__msg__VehicleState__copy(
