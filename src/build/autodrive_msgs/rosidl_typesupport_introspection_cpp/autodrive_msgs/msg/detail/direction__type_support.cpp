...
{
  new (message_memory) autodrive_msgs::msg::Direction(_init);
}

void Direction_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autodrive_msgs::msg::Direction *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Direction_message_member_array[1] = {
  {
    ...
    offsetof(autodrive_msgs::msg::Direction, type),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Direction_message_members = {
  ...
  1,  // number of fields
  sizeof(autodrive_msgs::msg::Direction),
...
{
  return &::autodrive_msgs::msg::rosidl_typesupport_introspection_cpp::Direction_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autodrive_msgs, msg, Direction)() {
  return &::autodrive_msgs::msg::rosidl_typesupport_introspection_cpp::Direction_message_type_support_handle;
}
