...
{
  new (message_memory) autodrive_msgs::msg::DynamicObstacle(_init);
}

void DynamicObstacle_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autodrive_msgs::msg::DynamicObstacle *>(message_memory);
  typed_message->~DynamicObstacle();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember DynamicObstacle_message_member_array[3] = {
  {
    "detection",  // name
    ...
    offsetof(autodrive_msgs::msg::DynamicObstacle, detection),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autodrive_msgs::msg::DynamicObstacle, obstacle_type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autodrive_msgs::msg::DynamicObstacle, dynamic_confidence),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DynamicObstacle_message_members = {
  ...
  3,  // number of fields
  sizeof(autodrive_msgs::msg::DynamicObstacle),
...
{
  return &::autodrive_msgs::msg::rosidl_typesupport_introspection_cpp::DynamicObstacle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autodrive_msgs, msg, DynamicObstacle)() {
  return &::autodrive_msgs::msg::rosidl_typesupport_introspection_cpp::DynamicObstacle_message_type_support_handle;
}
