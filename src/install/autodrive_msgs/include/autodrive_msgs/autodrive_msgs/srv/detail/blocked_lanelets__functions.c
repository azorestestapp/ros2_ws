...
autodrive_msgs__srv__BlockedLanelets_Request__init(autodrive_msgs__srv__BlockedLanelets_Request * msg)
{
  ...
  // blocked
  if (!rosidl_runtime_c__uint64__Sequence__init(&msg->blocked, 0)) {
    autodrive_msgs__srv__BlockedLanelets_Request__fini(msg);
    return false;
  }
  return true;
}
...
autodrive_msgs__srv__BlockedLanelets_Request__fini(autodrive_msgs__srv__BlockedLanelets_Request * msg)
{
  ...
  // blocked
  rosidl_runtime_c__uint64__Sequence__fini(&msg->blocked);
}
...
autodrive_msgs__srv__BlockedLanelets_Request__create()
{
  ...
  autodrive_msgs__srv__BlockedLanelets_Request * msg = (autodrive_msgs__srv__BlockedLanelets_Request *)allocator.allocate(sizeof(autodrive_msgs__srv__BlockedLanelets_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(autodrive_msgs__srv__BlockedLanelets_Request));
  bool success = autodrive_msgs__srv__BlockedLanelets_Request__init(msg);
  if (!success) {
...
autodrive_msgs__srv__BlockedLanelets_Request__Sequence__init(autodrive_msgs__srv__BlockedLanelets_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autodrive_msgs__srv__BlockedLanelets_Request * data = NULL;

  if (size) {
    data = (autodrive_msgs__srv__BlockedLanelets_Request *)allocator.zero_allocate(size, sizeof(autodrive_msgs__srv__BlockedLanelets_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = autodrive_msgs__srv__BlockedLanelets_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        autodrive_msgs__srv__BlockedLanelets_Request__fini(&data[i - 1]);
      }
...
autodrive_msgs__srv__BlockedLanelets_Request__Sequence__fini(autodrive_msgs__srv__BlockedLanelets_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      autodrive_msgs__srv__BlockedLanelets_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autodrive_msgs__srv__BlockedLanelets_Request__Sequence * array = (autodrive_msgs__srv__BlockedLanelets_Request__Sequence *)allocator.allocate(sizeof(autodrive_msgs__srv__BlockedLanelets_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = autodrive_msgs__srv__BlockedLanelets_Request__Sequence__init(array, size);
  if (!success) {
...
autodrive_msgs__srv__BlockedLanelets_Request__Sequence__destroy(autodrive_msgs__srv__BlockedLanelets_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    autodrive_msgs__srv__BlockedLanelets_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
autodrive_msgs__srv__BlockedLanelets_Request__Sequence__are_equal(const autodrive_msgs__srv__BlockedLanelets_Request__Sequence * lhs, const autodrive_msgs__srv__BlockedLanelets_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autodrive_msgs__srv__BlockedLanelets_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  autodrive_msgs__srv__BlockedLanelets_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autodrive_msgs__srv__BlockedLanelets_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    autodrive_msgs__srv__BlockedLanelets_Request * data =
      (autodrive_msgs__srv__BlockedLanelets_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autodrive_msgs__srv__BlockedLanelets_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autodrive_msgs__srv__BlockedLanelets_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!autodrive_msgs__srv__BlockedLanelets_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autodrive_msgs__srv__BlockedLanelets_Response * msg = (autodrive_msgs__srv__BlockedLanelets_Response *)allocator.allocate(sizeof(autodrive_msgs__srv__BlockedLanelets_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(autodrive_msgs__srv__BlockedLanelets_Response));
  bool success = autodrive_msgs__srv__BlockedLanelets_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
autodrive_msgs__srv__BlockedLanelets_Response__destroy(autodrive_msgs__srv__BlockedLanelets_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    autodrive_msgs__srv__BlockedLanelets_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
autodrive_msgs__srv__BlockedLanelets_Response__Sequence__init(autodrive_msgs__srv__BlockedLanelets_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autodrive_msgs__srv__BlockedLanelets_Response * data = NULL;

  if (size) {
    data = (autodrive_msgs__srv__BlockedLanelets_Response *)allocator.zero_allocate(size, sizeof(autodrive_msgs__srv__BlockedLanelets_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = autodrive_msgs__srv__BlockedLanelets_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        autodrive_msgs__srv__BlockedLanelets_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
autodrive_msgs__srv__BlockedLanelets_Response__Sequence__fini(autodrive_msgs__srv__BlockedLanelets_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      autodrive_msgs__srv__BlockedLanelets_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autodrive_msgs__srv__BlockedLanelets_Response__Sequence * array = (autodrive_msgs__srv__BlockedLanelets_Response__Sequence *)allocator.allocate(sizeof(autodrive_msgs__srv__BlockedLanelets_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = autodrive_msgs__srv__BlockedLanelets_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
autodrive_msgs__srv__BlockedLanelets_Response__Sequence__destroy(autodrive_msgs__srv__BlockedLanelets_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    autodrive_msgs__srv__BlockedLanelets_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
autodrive_msgs__srv__BlockedLanelets_Response__Sequence__are_equal(const autodrive_msgs__srv__BlockedLanelets_Response__Sequence * lhs, const autodrive_msgs__srv__BlockedLanelets_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autodrive_msgs__srv__BlockedLanelets_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  autodrive_msgs__srv__BlockedLanelets_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autodrive_msgs__srv__BlockedLanelets_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    autodrive_msgs__srv__BlockedLanelets_Response * data =
      (autodrive_msgs__srv__BlockedLanelets_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autodrive_msgs__srv__BlockedLanelets_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autodrive_msgs__srv__BlockedLanelets_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!autodrive_msgs__srv__BlockedLanelets_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
