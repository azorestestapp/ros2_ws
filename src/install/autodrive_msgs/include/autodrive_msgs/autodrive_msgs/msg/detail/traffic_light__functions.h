...
#ifndef AUTODRIVE_MSGS__MSG__DETAIL__TRAFFIC_LIGHT__FUNCTIONS_H_
#define AUTODRIVE_MSGS__MSG__DETAIL__TRAFFIC_LIGHT__FUNCTIONS_H_
 ...
 * calls
 * autodrive_msgs__msg__TrafficLight__init().
...
/**
 * It calls
 * autodrive_msgs__msg__TrafficLight__fini()
 ...
 * autodrive_msgs__msg__TrafficLight__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * autodrive_msgs__msg__TrafficLight__Sequence__fini()
 * on the array,
...
#endif  // AUTODRIVE_MSGS__MSG__DETAIL__TRAFFIC_LIGHT__FUNCTIONS_H_
