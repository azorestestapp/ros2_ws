...
class Metaclass_VehicleState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'autodrive_msgs.msg.VehicleState')
            logger.debug(
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'AWAITING_LOCATION': cls.__constants['AWAITING_LOCATION'],
            'AWAITING_DESTINATION': cls.__constants['AWAITING_DESTINATION'],
            'AWAITING_CONFIRM': cls.__constants['AWAITING_CONFIRM'],
            'MANUAL': cls.__constants['MANUAL'],
            'NAVIGATING': cls.__constants['NAVIGATING'],
        }

    @property
    def AWAITING_LOCATION(self):
        """Message constant 'AWAITING_LOCATION'."""
        return Metaclass_VehicleState.__constants['AWAITING_LOCATION']

    @property
    def AWAITING_DESTINATION(self):
        """Message constant 'AWAITING_DESTINATION'."""
        return Metaclass_VehicleState.__constants['AWAITING_DESTINATION']

    @property
    def AWAITING_CONFIRM(self):
        """Message constant 'AWAITING_CONFIRM'."""
        return Metaclass_VehicleState.__constants['AWAITING_CONFIRM']

    @property
    def MANUAL(self):
        """Message constant 'MANUAL'."""
        return Metaclass_VehicleState.__constants['MANUAL']

    @property
    def NAVIGATING(self):
        """Message constant 'NAVIGATING'."""
        return Metaclass_VehicleState.__constants['NAVIGATING']
