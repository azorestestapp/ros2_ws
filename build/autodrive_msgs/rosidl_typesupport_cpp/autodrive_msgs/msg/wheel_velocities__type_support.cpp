...
static const _WheelVelocities_type_support_symbol_names_t _WheelVelocities_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autodrive_msgs, msg, WheelVelocities)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autodrive_msgs, msg, WheelVelocities)),
  }
};
...
{
  return &::autodrive_msgs::msg::rosidl_typesupport_cpp::WheelVelocities_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, autodrive_msgs, msg, WheelVelocities)() {
  return get_message_type_support_handle<autodrive_msgs::msg::WheelVelocities>();
}
