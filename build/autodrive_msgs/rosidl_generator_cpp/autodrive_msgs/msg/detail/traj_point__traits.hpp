...
#ifndef AUTODRIVE_MSGS__MSG__DETAIL__TRAJ_POINT__TRAITS_HPP_
#define AUTODRIVE_MSGS__MSG__DETAIL__TRAJ_POINT__TRAITS_HPP_
...
inline std::string to_yaml(const TrajPoint & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const autodrive_msgs::msg::TrajPoint & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const autodrive_msgs::msg::TrajPoint & msg)
{
  return autodrive_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<autodrive_msgs::msg::TrajPoint>()
{
  return "autodrive_msgs::msg::TrajPoint";
}

template<>
inline const char * name<autodrive_msgs::msg::TrajPoint>()
{
  return "autodrive_msgs/msg/TrajPoint";
}

template<>
struct has_fixed_size<autodrive_msgs::msg::TrajPoint>
  : std::integral_constant<bool, has_fixed_size<autodrive_msgs::msg::Direction>::value> {};

template<>
struct has_bounded_size<autodrive_msgs::msg::TrajPoint>
  : std::integral_constant<bool, has_bounded_size<autodrive_msgs::msg::Direction>::value> {};

template<>
struct is_message<autodrive_msgs::msg::TrajPoint>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // AUTODRIVE_MSGS__MSG__DETAIL__TRAJ_POINT__TRAITS_HPP_
