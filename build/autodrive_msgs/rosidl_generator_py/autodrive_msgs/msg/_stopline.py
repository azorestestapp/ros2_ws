...
class Metaclass_Stopline(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__stopline
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__stopline
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__stopline
            cls._TYPE_SUPPORT = module.type_support_msg__msg__stopline
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__stopline
...
class Stopline(metaclass=Metaclass_Stopline):
    ...
    def __init__(self, **kwargs):
        ...
        self.stopline_confidence = kwargs.get('stopline_confidence', float())
    ...
    def __eq__(self, other):
        ...
        if self.detection != other.detection:
            return False
        if self.stopline_confidence != other.stopline_confidence:
            return False
        return True
    ...
    @builtins.property
    def stopline_confidence(self):
        """Message field 'stopline_confidence'."""
        return self._stopline_confidence

    @stopline_confidence.setter
    def stopline_confidence(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'stopline_confidence' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'stopline_confidence' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._stopline_confidence = value
