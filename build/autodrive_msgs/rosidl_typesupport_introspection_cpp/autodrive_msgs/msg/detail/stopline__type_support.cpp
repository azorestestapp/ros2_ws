...
{
  new (message_memory) autodrive_msgs::msg::Stopline(_init);
}

void Stopline_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autodrive_msgs::msg::Stopline *>(message_memory);
  typed_message->~Stopline();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Stopline_message_member_array[2] = {
  {
    "detection",  // name
    ...
    offsetof(autodrive_msgs::msg::Stopline, detection),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autodrive_msgs::msg::Stopline, stopline_confidence),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Stopline_message_members = {
  ...
  2,  // number of fields
  sizeof(autodrive_msgs::msg::Stopline),
...
{
  return &::autodrive_msgs::msg::rosidl_typesupport_introspection_cpp::Stopline_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autodrive_msgs, msg, Stopline)() {
  return &::autodrive_msgs::msg::rosidl_typesupport_introspection_cpp::Stopline_message_type_support_handle;
}
