...
#include "autodrive_msgs/msg/detail/direction__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autodrive_msgs::msg::Direction & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autodrive_msgs::msg::Direction & ros_message)
{
  // Member: type
  cdr >> ros_message.type;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autodrive_msgs::msg::Direction;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autodrive_msgs::msg::Direction *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autodrive_msgs::msg::Direction *>(
    untyped_ros_message);
...
{
  return &autodrive_msgs::msg::typesupport_fastrtps_cpp::_Direction__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autodrive_msgs, msg, Direction)() {
  return &autodrive_msgs::msg::typesupport_fastrtps_cpp::_Direction__handle;
}
