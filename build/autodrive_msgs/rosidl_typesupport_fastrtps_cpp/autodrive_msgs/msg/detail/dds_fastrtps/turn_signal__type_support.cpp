...
#include "autodrive_msgs/msg/detail/turn_signal__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autodrive_msgs::msg::TurnSignal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autodrive_msgs::msg::TurnSignal & ros_message)
{
  // Member: signal
  cdr >> ros_message.signal;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autodrive_msgs::msg::TurnSignal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autodrive_msgs::msg::TurnSignal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autodrive_msgs::msg::TurnSignal *>(
    untyped_ros_message);
...
static size_t _TurnSignal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TurnSignal(full_bounded, is_plain, 0);
...
{
  return &autodrive_msgs::msg::typesupport_fastrtps_cpp::_TurnSignal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autodrive_msgs, msg, TurnSignal)() {
  return &autodrive_msgs::msg::typesupport_fastrtps_cpp::_TurnSignal__handle;
}
