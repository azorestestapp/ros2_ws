...
#include "autodrive_msgs/msg/detail/shared_pointer_reference__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autodrive_msgs::msg::SharedPointerReference & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: shared_pointer_key
  cdr << ros_message.shared_pointer_key;
  // Member: map_active
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autodrive_msgs::msg::SharedPointerReference & ros_message)
{
  // Member: shared_pointer_key
  cdr >> ros_message.shared_pointer_key;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_autodrive_msgs
max_serialized_size_SharedPointerReference(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autodrive_msgs::msg::SharedPointerReference;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autodrive_msgs::msg::SharedPointerReference *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autodrive_msgs::msg::SharedPointerReference *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SharedPointerReference__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const autodrive_msgs::msg::SharedPointerReference *>(
...
static size_t _SharedPointerReference__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SharedPointerReference(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SharedPointerReference__callbacks = {
  "autodrive_msgs::msg",
...
static rosidl_message_type_support_t _SharedPointerReference__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SharedPointerReference__callbacks,
...
{
  return &autodrive_msgs::msg::typesupport_fastrtps_cpp::_SharedPointerReference__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autodrive_msgs, msg, SharedPointerReference)() {
  return &autodrive_msgs::msg::typesupport_fastrtps_cpp::_SharedPointerReference__handle;
}
