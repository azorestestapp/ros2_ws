...
#include "autodrive_msgs/msg/detail/trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const autodrive_msgs::msg::TrajPoint &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const autodrive_msgs::msg::Trajectory & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autodrive_msgs::msg::Trajectory & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        autodrive_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_TrajPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = autodrive_msgs::msg::Trajectory;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autodrive_msgs::msg::Trajectory *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autodrive_msgs::msg::Trajectory *>(
    untyped_ros_message);
...
{
  return &autodrive_msgs::msg::typesupport_fastrtps_cpp::_Trajectory__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autodrive_msgs, msg, Trajectory)() {
  return &autodrive_msgs::msg::typesupport_fastrtps_cpp::_Trajectory__handle;
}
