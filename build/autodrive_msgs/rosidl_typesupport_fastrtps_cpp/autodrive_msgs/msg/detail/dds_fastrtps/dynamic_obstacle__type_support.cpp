...
#include "autodrive_msgs/msg/detail/dynamic_obstacle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autodrive_msgs::msg::DynamicObstacle & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autodrive_msgs::msg::DynamicObstacle & ros_message)
{
  // Member: detection
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autodrive_msgs::msg::DynamicObstacle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autodrive_msgs::msg::DynamicObstacle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autodrive_msgs::msg::DynamicObstacle *>(
    untyped_ros_message);
...
{
  return &autodrive_msgs::msg::typesupport_fastrtps_cpp::_DynamicObstacle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autodrive_msgs, msg, DynamicObstacle)() {
  return &autodrive_msgs::msg::typesupport_fastrtps_cpp::_DynamicObstacle__handle;
}
