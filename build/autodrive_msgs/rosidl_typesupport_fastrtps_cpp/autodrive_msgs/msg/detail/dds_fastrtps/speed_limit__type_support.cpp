...
#include "autodrive_msgs/msg/detail/speed_limit__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autodrive_msgs::msg::SpeedLimit & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autodrive_msgs::msg::SpeedLimit & ros_message)
{
  // Member: detection
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autodrive_msgs::msg::SpeedLimit;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autodrive_msgs::msg::SpeedLimit *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autodrive_msgs::msg::SpeedLimit *>(
    untyped_ros_message);
...
static size_t _SpeedLimit__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SpeedLimit(full_bounded, is_plain, 0);
...
{
  return &autodrive_msgs::msg::typesupport_fastrtps_cpp::_SpeedLimit__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autodrive_msgs, msg, SpeedLimit)() {
  return &autodrive_msgs::msg::typesupport_fastrtps_cpp::_SpeedLimit__handle;
}
