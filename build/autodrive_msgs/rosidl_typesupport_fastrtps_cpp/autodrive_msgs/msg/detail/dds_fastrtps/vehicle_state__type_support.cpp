...
#include "autodrive_msgs/msg/detail/vehicle_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autodrive_msgs::msg::VehicleState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autodrive_msgs::msg::VehicleState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autodrive_msgs::msg::VehicleState *>(
    untyped_ros_message);
...
{
  return &autodrive_msgs::msg::typesupport_fastrtps_cpp::_VehicleState__handle;
}
