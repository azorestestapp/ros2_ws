...
bool autodrive_msgs__msg__location__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autodrive_msgs.msg._location.Location", full_classname_dest, 37) == 0);
  }
  autodrive_msgs__msg__Location * ros_message = _ros_message;
  {  // location
    ...
    ros_message->location = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // latitude
...
PyObject * autodrive_msgs__msg__location__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autodrive_msgs.msg._location");
