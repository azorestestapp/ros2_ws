...
#include "autodrive_msgs/msg/detail/dynamic_obstacle__rosidl_typesupport_fastrtps_c.h"
...
using _DynamicObstacle__ros_msg_type = autodrive_msgs__msg__DynamicObstacle;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _DynamicObstacle__ros_msg_type * ros_message = static_cast<const _DynamicObstacle__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: dynamic_confidence
  {
    cdr << ros_message->dynamic_confidence;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _DynamicObstacle__ros_msg_type * ros_message = static_cast<_DynamicObstacle__ros_msg_type *>(untyped_ros_message);
  // Field name: detection
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  size_t current_alignment)
{
  ...
  // field.name dynamic_confidence
  {
    size_t item_size = sizeof(ros_message->dynamic_confidence);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _DynamicObstacle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autodrive_msgs__msg__DynamicObstacle(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autodrive_msgs__msg__DynamicObstacle;
    is_plain =
      (
      offsetof(DataType, dynamic_confidence) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _DynamicObstacle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autodrive_msgs__msg__DynamicObstacle(
...
static message_type_support_callbacks_t __callbacks_DynamicObstacle = {
  "autodrive_msgs::msg",
  "DynamicObstacle",
...
static rosidl_message_type_support_t _DynamicObstacle__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_DynamicObstacle,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autodrive_msgs, msg, DynamicObstacle)() {
  return &_DynamicObstacle__type_support;
}
