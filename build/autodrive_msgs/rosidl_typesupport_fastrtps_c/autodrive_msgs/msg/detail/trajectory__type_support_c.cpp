...
#include "autodrive_msgs/msg/detail/trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "autodrive_msgs/msg/detail/traj_point__functions.h"  // points
...
using _Trajectory__ros_msg_type = autodrive_msgs__msg__Trajectory;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: points
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, autodrive_msgs, msg, TrajPoint
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: points
  {
    ...
    if (ros_message->points.data) {
      autodrive_msgs__msg__TrajPoint__Sequence__fini(&ros_message->points);
    }
    if (!autodrive_msgs__msg__TrajPoint__Sequence__init(&ros_message->points, size)) {
...
size_t get_serialized_size_autodrive_msgs__msg__Trajectory(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Trajectory__ros_msg_type * ros_message = static_cast<const _Trajectory__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_autodrive_msgs__msg__TrajPoint(
...
static uint32_t _Trajectory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autodrive_msgs__msg__Trajectory(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autodrive_msgs
size_t max_serialized_size_autodrive_msgs__msg__Trajectory(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_autodrive_msgs__msg__TrajPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = autodrive_msgs__msg__Trajectory;
    is_plain =
      (
...
static size_t _Trajectory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autodrive_msgs__msg__Trajectory(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autodrive_msgs, msg, Trajectory)() {
