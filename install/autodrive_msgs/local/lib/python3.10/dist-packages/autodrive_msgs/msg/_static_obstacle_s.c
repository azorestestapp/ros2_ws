...
bool autodrive_msgs__msg__static_obstacle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autodrive_msgs.msg._static_obstacle.StaticObstacle", full_classname_dest, 50) == 0);
  }
  autodrive_msgs__msg__StaticObstacle * ros_message = _ros_message;
  {  // detection
  ...
  {  // static_obstacle_confidence
    PyObject * field = PyObject_GetAttrString(_pymsg, "static_obstacle_confidence");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->static_obstacle_confidence = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of StaticObstacle */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("autodrive_msgs.msg._static_obstacle");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "StaticObstacle");
  ...
  {  // static_obstacle_confidence
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->static_obstacle_confidence);
    {
      int rc = PyObject_SetAttrString(_pymessage, "static_obstacle_confidence", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
