...
bool autodrive_msgs__msg__dynamic_obstacle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autodrive_msgs.msg._dynamic_obstacle.DynamicObstacle", full_classname_dest, 52) == 0);
  }
  autodrive_msgs__msg__DynamicObstacle * ros_message = _ros_message;
  {  // detection
  ...
  {  // dynamic_confidence
    PyObject * field = PyObject_GetAttrString(_pymsg, "dynamic_confidence");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->dynamic_confidence = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * autodrive_msgs__msg__dynamic_obstacle__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autodrive_msgs.msg._dynamic_obstacle");
  ...
  {  // dynamic_confidence
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->dynamic_confidence);
    {
      int rc = PyObject_SetAttrString(_pymessage, "dynamic_confidence", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
