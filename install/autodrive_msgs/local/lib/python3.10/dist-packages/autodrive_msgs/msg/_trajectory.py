...
class Metaclass_Trajectory(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from autodrive_msgs.msg import TrajPoint
            if TrajPoint.__class__._TYPE_SUPPORT is None:
                TrajPoint.__class__.__import_type_support__()
...
class Trajectory(metaclass=Metaclass_Trajectory):
    ...
    _fields_and_field_types = {
        ...
        'points': 'sequence<autodrive_msgs/TrajPoint>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['autodrive_msgs', 'msg'], 'TrajPoint')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, TrajPoint) for v in value) and
                 True), \
                "The 'points' field must be a set or sequence and each value of type 'TrajPoint'"
        self._points = value
