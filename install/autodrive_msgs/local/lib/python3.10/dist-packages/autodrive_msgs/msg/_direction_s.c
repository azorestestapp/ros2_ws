...
bool autodrive_msgs__msg__direction__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autodrive_msgs.msg._direction.Direction", full_classname_dest, 39) == 0);
  }
  autodrive_msgs__msg__Direction * ros_message = _ros_message;
  {  // type
...
PyObject * autodrive_msgs__msg__direction__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autodrive_msgs.msg._direction");
