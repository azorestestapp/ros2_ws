...
#ifndef AUTODRIVE_MSGS__MSG__DETAIL__STOPLINE__TRAITS_HPP_
#define AUTODRIVE_MSGS__MSG__DETAIL__STOPLINE__TRAITS_HPP_
  ...
  std::ostream & out)
{
  ...
  {
    out << "stopline_confidence: ";
    rosidl_generator_traits::value_to_yaml(msg.stopline_confidence, out);
  }
  out << "}";
...
inline void to_yaml(
  const autodrive_msgs::msg::Stopline & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const autodrive_msgs::msg::Stopline & msg)
{
  return autodrive_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<autodrive_msgs::msg::Stopline>()
{
  return "autodrive_msgs::msg::Stopline";
}

template<>
inline const char * name<autodrive_msgs::msg::Stopline>()
{
  return "autodrive_msgs/msg/Stopline";
}

template<>
struct has_fixed_size<autodrive_msgs::msg::Stopline>
  : std::integral_constant<bool, has_fixed_size<autodrive_msgs::msg::GeneralDetection>::value> {};

template<>
struct has_bounded_size<autodrive_msgs::msg::Stopline>
  : std::integral_constant<bool, has_bounded_size<autodrive_msgs::msg::GeneralDetection>::value> {};

template<>
struct is_message<autodrive_msgs::msg::Stopline>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // AUTODRIVE_MSGS__MSG__DETAIL__STOPLINE__TRAITS_HPP_
